import Vue from 'vue'
import { FETCHFORUMS, FETCHFORUM, ADDFORUM, UPDATEFORUMBYTOPIC, 
         UPDATEFORUM, DELETEFORUM, DELETEFORUMTOPICID } from './action-types'
...
export default {
  ...
  [FETCHFORUMS] ({ commit, dispatch }) {  
    ...
    [ADDFORUM] ({ commit, dispatch }, forum)  {
      return v.$forums.addForum(forum)
        .then(({ data }) => {
